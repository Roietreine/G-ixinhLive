package com.example.gaixinhlive.jumpcode_features.presentation

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import androidx.lifecycle.ViewModelProvider
import com.example.gaixinhlive.R
import com.example.gaixinhlive.jumpcode_features.utils.UiState
import com.example.gaixinhlive.jumpcode_features.utils.isNetworkConnected
import com.example.gaixinhlive.jumpcode_features.viewmodel.JumpCodeViewModel
    ...
    private fun toNextActivity(url: String? = null) {
        startActivity(
            WebViewActivity.createIntent(
                this,
                url ?: "file:///android_asset/girls.html"
            )
        )
